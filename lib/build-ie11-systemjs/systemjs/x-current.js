System.register(['./utilities-b59a80a0.js'], function (exports, module) {
  'use strict';
  var convertTemperature, dateTime, loadComponent, to12HourTime, unixEpochToDate, classCallCheck, createClass, inherits, possibleConstructorReturn, toConsumableArray;
  return {
    setters: [function (module) {
      convertTemperature = module.g;
      dateTime = module.h;
      loadComponent = module.a;
      to12HourTime = module.i;
    ...
    execute: function () {
      ...
      var XCurrent = function (_HTMLElement) {
        inherits(XCurrent, _HTMLElement);
